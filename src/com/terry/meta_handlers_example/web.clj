(ns com.terry.meta-handlers-example.web
  (:use compojure.core)
  (:use ring.adapter.jetty)
  (:use ring.middleware.reload)
  (:use [clojure.tools.logging :only (debug info error)])
  (:require [com.terry.meta-handlers-example.middleware :as middleware]
            [com.terry.meta-handlers.front-controller :as front-controller]
...
(defn app [request]
  (-> request
      (wrap-logging)
      (front-controller/handle 'com.terry.meta-handlers-example.integration.web)
      ;(wrap-exception)
      ))
